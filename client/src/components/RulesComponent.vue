<template>
  <div class="Rules">
      ...
      <ol>
        ...
        <li><strong>IMPORTANT: </strong> Picking a team is very CRUCIAL. It is the only thing that you will have control of in this league. Once your team is picked and approved you will not be able to make any trades or changes throughout the ENTIRE PLAYOFFS. This means that if a team that a player you have chosen is on becomes eliminated that player will obviously no longer be in the tournament and will therefore no longer be able to acquire points for your team. This also means that if a player you have chosen becomes injured then tough luck for both of you (but mostly you).</li>
        <li>Submissions are now closed. Tie breakers will look at the following:
          <ol type='A'>
            <li>Most active players on team in the end</li>
            <li>Most goals scored by team in total</li> 
            <li>Team whose player has the highest point total between those tied</li>
          </ol>
        </li>
      </ol>
